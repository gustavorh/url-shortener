...
export default function Home() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const payload: { originalUrl: string; expirationDate?: string } = {
        originalUrl: url,
      };
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
              La forma más rápida y sencilla de crear links cortos para
              compartir en redes sociales, mensajes o correos.
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center space-x-2">
                <div className="relative inline-flex items-center cursor-pointer">
                  ...
                  />
                  <div
                    className={`w-11 h-6 rounded-full peer-focus:ring-2 peer-focus:ring-gray-600 after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all ${
                      hasExpiration
                ...
                <div>
                  ...
                  <div className="mt-2 flex items-start space-x-2 p-2 bg-blue-50 dark:bg-blue-900/20 rounded border border-blue-100 dark:border-blue-800">
                    ...
                    <p className="text-sm text-blue-700 dark:text-blue-300">
                      Por defecto, se ha establecido un tiempo de expiración de
                      1 día. Puedes modificarlo según tus necesidades.
                    </p>
                  </div>
                  {expirationDate && !isValidExpirationDate(expirationDate) && (
                    <p className="mt-1 text-sm text-red-500">
                      La fecha de expiración debe ser al menos 5 minutos en el
                      futuro
                    </p>
                  )}
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Acorta tus URLs con un solo clic, sin registros obligatorios.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Servicio 100% gratuito, sin costos ocultos ni limitaciones.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Accede a tus enlaces acortados recientes fácilmente.
              </p>
            </div>
          </div>
        </div>
